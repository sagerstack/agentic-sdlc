...
The Researcher investigates the epic BEFORE the BA creates stories. Research findings inform story creation, complexity scoring, and technical decisions. Never skip research.
...
- [ ] `docs/phases/epic-{NNN}-{desc}/research/findings.md` created
