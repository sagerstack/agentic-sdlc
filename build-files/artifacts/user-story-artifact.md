...
**Instructions for Business Analyst Agent**:
...
### Template Structure (Copy to Generated Story):
...
**Purpose**: Provide technical constraints to guide solution-architect research and implementation planning.

**Instructions for Business Analyst Agent**:
- Copy ONLY the category labels from the template
- Each category must have exactly ONE bullet point with placeholder: [INSERT_USER_INPUT]
- DO NOT fill in any content values - user will provide technical guidance later
